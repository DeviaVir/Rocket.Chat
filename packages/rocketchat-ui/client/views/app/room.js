...
Template.room.onCreated(function() {
	...
	//Meteor.call('setCurrentRoom', Meteor.userId(), this.data._id, (error, result) => { });
...
Template.room.onDestroyed(function() {
	...
	//Meteor.call('setCurrentRoom', Meteor.userId(), null, (error, result) => {	});
});
...
Template.room.onRendered(function() {
	...
	//Meteor.call('setCurrentRoom', Meteor.userId(), rid, (error, result) => {	});
